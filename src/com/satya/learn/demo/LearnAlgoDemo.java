...
import com.satya.learn.java.algos.sorting.QuickSort;
...
public class LearnAlgoDemo {
	...
	public static void main(String[] args) {
		...
		// { 62, 8, 832, 34, 4, 164, 5, 142, 11, 3, 1, 253, 82, 6, 55, 10, 122, 2, 76,
		// 23, 5, 533, 15, 28 };
		{ 688, 865, 687, 890, 884, 972, 758, 589, 947, 292, 841, 192, 43, 781, 275, 989, 232, 648, 100, 576, 962, 31,
				14, 229, 286, 811, 909, 520, 7, 595, 859, 667, 326, 404, 727, 499, 916, 477, 433, 696, 943, 20, 111,
				276, 414, 878, 115, 631, 23, 955, 360, 316, 993 };
		
		String[] strElements = new String[] { "satya", "xyz", "hari", "giri", "mukesh", "ruchi", "kavi", "ravi" };
		...
		// Sort<Integer> sorting = new QuickSort<>();
